    ...
    installFetchMock([
      {
        ...
        match: /\/version$/,
        json: {
          bundleName: 'Fake Services',
          bundleVendor: 'SBB',
          supportEmail: 'polarion-opensource@sbb.ch',
          automaticModuleName: 'ch.sbb.polarion.extension.fake_services',
          bundleVersion: '1.0.0',
      ...
      },
      {
        ...
        json: {
          properties: [
            {
              key: 'ch.sbb.polarion.extension.fake-services.some.property',
              value: 'value',
              defaultValue: 'value',
      ...
      },
      {
        ...
        json: [{ name: 'Fake Services', status: 'OK', details: 'ready' }],
      },
      {
        method: 'GET',
        match: /\/readme$/,
        respond: () =>
          new Response('<h1>Fake Services Extension for Polarion ALM</h1><p>Stubs external services for testing.</p>', {
            status: 200,
          }),
      },
    ]);
