...
// this extension's plain JS tooling. src/vendor holds the vendored petrel code editor + highlight.js +
// jsonlint (kept verbatim from the legacy webapp); it is third-party and not restyled here, so it is
