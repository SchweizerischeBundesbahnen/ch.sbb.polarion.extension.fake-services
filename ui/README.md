...
`/polarion/fake-services-app/ui/app/`. The Maven build (frontend-maven-plugin +
maven-resources-plugin) runs this automatically and copies the bundle into
`src/main/resources/webapp/fake-services-app/app`, where `AadSynchronizerAppServlet` serves it at
`/polarion/fake-services-app/ui/app/index.html`.
